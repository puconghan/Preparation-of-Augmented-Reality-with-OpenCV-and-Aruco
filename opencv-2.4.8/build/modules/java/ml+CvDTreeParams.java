...
public class CvDTreeParams {
    ...
    //javadoc: CvDTreeParams::get_max_categories()
    ...
    //javadoc: CvDTreeParams::set_max_categories(max_categories)
    ...
    //javadoc: CvDTreeParams::get_max_depth()
    ...
    //javadoc: CvDTreeParams::set_max_depth(max_depth)
    ...
    //javadoc: CvDTreeParams::get_min_sample_count()
    ...
    //javadoc: CvDTreeParams::set_min_sample_count(min_sample_count)
    ...
    //javadoc: CvDTreeParams::get_cv_folds()
    ...
    //javadoc: CvDTreeParams::set_cv_folds(cv_folds)
    ...
    //javadoc: CvDTreeParams::get_use_surrogates()
    ...
    //javadoc: CvDTreeParams::set_use_surrogates(use_surrogates)
    ...
    //javadoc: CvDTreeParams::get_use_1se_rule()
    ...
    //javadoc: CvDTreeParams::set_use_1se_rule(use_1se_rule)
    ...
    //javadoc: CvDTreeParams::get_truncate_pruned_tree()
    ...
    //javadoc: CvDTreeParams::set_truncate_pruned_tree(truncate_pruned_tree)
    ...
    //javadoc: CvDTreeParams::get_regression_accuracy()
    ...
    //javadoc: CvDTreeParams::set_regression_accuracy(regression_accuracy)
