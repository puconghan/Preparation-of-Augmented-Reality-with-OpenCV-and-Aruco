...
public class Contrib {
    ...
    //javadoc: chamerMatching(img, templ, results, cost, templScale, maxMatches, minMatchDistance, padX, padY, scales, minScale, maxScale, orientationWeight, truncate)
    ...
    //javadoc: chamerMatching(img, templ, results, cost)
